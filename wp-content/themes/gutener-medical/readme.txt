...
Gutener Medical includes support for WooCommerce, Elementor, Breadcrumb NavXT and Contact From 7.
...
= 1.1.0 =
* Structure Updated.
* Elementor plugin compatibility updated.
* Style Updated.
* Title-tag and automatic-feed-links support added.
...
= 1.0.5 =
* This version updated a escaping.

= 1.0.4 =
* This version updated a escaping and theme URI.
...
* Image for theme screenshot, Copyright Edwintp
